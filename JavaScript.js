...
//Function that evaluates if there is enough input to perform a calculation, and if so, executes it  
...
//Main function which handles all user input, and checks for illigal actions and displays the input to the user  
